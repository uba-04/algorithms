...
public class ThreadSafeArrayListImplementationTest {

  ThreadSafeArrayListImplementation<Integer> arrayList;

  @BeforeEach
  void setUp() {
    arrayList = new ThreadSafeArrayListImplementation<>();
  }
  ...
  void add_addsElementToArrayListAndIncreasesSize_whenUsingParameterizedConstructor() {
    // Given
    var arrayList = new ThreadSafeArrayListImplementation<Integer>(2);
    int element1 = 5;
    int element2 = 10;
    int element3 = 15;
    int expectedSize = 3;
